...
export function ConversationCard({
  ...
  return (
    <button
      onClick={onClick}
      className={`w-full max-w-full flex items-center gap-4 px-4 py-4 transition-all duration-200 text-left border-b border-border/50 hover:bg-[var(--hover-surface)] overflow-hidden active:bg-[var(--hover-muted)] ${
        isActive ? 'bg-muted' : ''
      }`}
    ...
    >
      ...
      <div className="flex-1 min-w-0">
        <div className="flex items-baseline justify-between mb-0.5 gap-2">
          <h3 className={`truncate text-[16px] leading-tight ${
