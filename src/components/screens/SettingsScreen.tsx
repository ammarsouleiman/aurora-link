...
export function SettingsScreen({ currentUser, onBack, onUserUpdate, theme, onToggleTheme }: SettingsScreenProps) {
  ...
  return (
    <div className="h-screen flex flex-col bg-background">
      ...
      <div className="flex-1 overflow-y-auto">
        ...
        <div className="mt-6">
          <div className="px-6 py-2">
            <p className="text-sm text-primary">Appearance</p>
          </div>
              ...
              <button 
                ...
                className={`px-4 py-3 rounded-lg text-center transition-all ${
                  themePreference === 'light' 
                    ...
                    : 'bg-muted/30 hover:bg-[var(--hover-surface)]'
                }`}
              >
                Light
              </button>
