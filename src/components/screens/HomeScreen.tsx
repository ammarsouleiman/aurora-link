    ...
    <div className="h-screen-safe flex flex-col bg-background overflow-hidden w-full max-w-full no-overscroll">
      ...
      <div className="flex-1 overflow-y-auto overflow-x-hidden w-full smooth-scroll">
        {selectedTab === 'chats' ? (
          <>
            {/* Search Bar */}
            <div className="bg-surface px-3 py-2 border-b border-border sticky top-0 z-10">
              <div className="relative w-full">
                ...
                <Input
                  ...
                  className="pl-9 pr-3 h-9 bg-input-background rounded-[18px] border-0 focus:ring-1 focus:ring-primary/20 text-sm mobile-input w-full"
                />
              </div>
            </div>
